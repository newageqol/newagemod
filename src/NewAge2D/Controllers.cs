...
internal static class Controllers
{
    ...
    {
        var holder = Holder();
        return holder != null ? holder.GetController<T>() : default;
    }
    ...
    private static IControllerContainer Holder()
    {
        ...
        if (_holder != null && (_holder is not UnityEngine.Object alive || alive != null)) return _holder;
        _holder = null;
        if (UnityEngine.Time.unscaledTime < _askAt) return null;
        _askAt = UnityEngine.Time.unscaledTime + 0.25f;
