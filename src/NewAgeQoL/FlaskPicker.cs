...
namespace NewAgeQoL
{
    internal static class FlaskPicker
    {
        ...
        private static void Build(string title)
        {
            ...
            var titleT = Line(panelGo.transform, (title ?? "") + " — выбери банку", 22, FontStyle.Bold, WardrobeLook.Bright);
            ...
            _note = Line(panelGo.transform, "", 15, FontStyle.Normal, WardrobeLook.Label);
            ...
            nrt.offsetMin = new Vector2(12f, -74f); nrt.offsetMax = new Vector2(-12f, -48f);
            ...
            var xT = Line(closeGo.transform, "X", 20, FontStyle.Bold, WardrobeLook.DangerText);
            ...
            srt.offsetMin = new Vector2(12f, 12f); srt.offsetMax = new Vector2(-12f, -76f);
